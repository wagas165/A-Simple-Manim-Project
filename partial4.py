...
class ConfigNewStation(ConfigStation):
    ...
    def create_station(self):
        ...
        self.components = [station.components]
        if self.horizontal:
...
class SetStationBackground(VGroup):
    ...
    def set_components(self, center_coordinate, station_size, station_radius_ratio, route_width, station_stroke_width, station_stroke_color, background_color, horizontal):
        ...
        if horizontal:
            ...
            self.components = [
                Rectangle(height=unify(2 * radius), width=unify(2 * half_width), stroke_width=0, fill_color=background_color, fill_opacity=1).move_to(change(center_coordinate)),
                ...
                Arc(start_angle=PI / 2, angle=PI, arc_center=change(left_center), radius=unify(radius), fill_color=background_color, fill_opacity=1, stroke_width=station_stroke_width, stroke_color=station_stroke_color, stroke_opacity=1),
                ...
                Arc(start_angle=PI * 3 / 2, angle=PI, arc_center=change(right_center), radius=unify(radius), fill_color=background_color, fill_opacity=1, stroke_width=station_stroke_width, stroke_color=station_stroke_color, stroke_opacity=1),
            ]
        else:
            up_center = center_coordinate + half_width * PLAIN_UP
            down_center = center_coordinate + half_width * PLAIN_DOWN
            self.components = [
                Rectangle(height=unify(2 * half_width), width=unify(2 * radius), stroke_width=0, fill_color=background_color, fill_opacity=1).move_to(change(center_coordinate)),
                Arc(start_angle=0, angle=PI, arc_center=change(up_center), radius=unify(radius), fill_color=background_color, fill_opacity=1, stroke_width=station_stroke_width, stroke_color=station_stroke_color, stroke_opacity=1),
